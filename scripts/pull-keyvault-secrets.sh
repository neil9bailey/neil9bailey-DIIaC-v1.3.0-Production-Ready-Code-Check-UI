...
#   - az login completed
#   - Key Vault populated (see VENDORLOGIC_LOCAL_STAGING_GUIDE.md Step 4)
#
# Outputs:
...
# Safe to commit. Loaded from customer-config/vendorlogic/config.env
...
# Generated by scripts/pull-keyvault-secrets.sh on $(date -u +"%Y-%m-%dT%H:%M:%SZ")
