...
$configFile  = Join-Path $repoRoot "customer-config" "vendorlogic" "config.env"
$configVars  = @{}
...
$KV_NAME              = $env:KEY_VAULT_NAME     ?? (Cfg "KEY_VAULT_NAME"          "kv-diiac-vendorlogic")
$ENTRA_TENANT_ID      = $env:AZURE_TENANT_ID    ?? (Cfg "AZURE_TENANT_ID"         "1384b1c5-2bae-45a1-a4b4-e94e3315eb41")
$ENTRA_API_APP_ID     = $env:ENTRA_API_APP_ID   ?? (Cfg "ENTRA_API_APP_ID"        "b726558d-f1c6-48f7-8a3d-72d5db818d0f")
$ENTRA_UI_APP_ID      = $env:ENTRA_UI_APP_ID    ?? (Cfg "ENTRA_UI_APP_ID"         "b726558d-f1c6-48f7-8a3d-72d5db818d0f")
$ENTRA_ADMIN_GROUP_ID = $env:ENTRA_ADMIN_GROUP_ID ?? (Cfg "ENTRA_ADMIN_GROUP_ID"  "81786818-de16-4115-b061-92fce74b00bd")
$ENTRA_USER_GROUP_ID  = $env:ENTRA_STANDARD_GROUP_ID ?? (Cfg "ENTRA_STANDARD_GROUP_ID" "9c7dd0d4-5b44-4811-b167-e52df21092d8")
...
[System.IO.File]::WriteAllBytes((Join-Path $PSScriptRoot ".." ".env"), $envBytes)
