...
const PYTHON_BASE = process.env.PYTHON_BASE_URL || "http://governance-runtime:8000";
...
app.get("/decision-pack/:execution_id/export",
  ...
  (req, res) => proxyToPython(req, res, `/decision-pack/${req.params.execution_id}/export`)
);
...
app.get("/admin/db/status", requireRole(["admin"]), (req, res) => proxyToPython(req, res, "/admin/db/status"));
app.get("/admin/db/table/:table", requireRole(["admin"]), (req, res) => proxyToPython(req, res, `/admin/db/table/${req.params.table}`));
app.post("/admin/db/maintenance/compact", requireRole(["admin"]), (req, res) => proxyToPython(req, res, "/admin/db/maintenance/compact"));
