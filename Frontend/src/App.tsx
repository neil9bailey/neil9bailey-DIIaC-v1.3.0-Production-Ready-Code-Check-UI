...
// as authConfig.ts so it stays true even when .env is not loaded.
...
export default function App() {
  ...
  const llmProvider: LlmProvider = "Copilot";
  ...
  // Loading state (auth status check or MSAL processing redirect)
  if (authStatusLoading || (msalEnabled && msalLoading)) {
    return (
      <div className="app-container">
        ...
        <main className="main-content">
          <div className="panel" style={{ maxWidth: 400, margin: "80px auto", textAlign: "center" }}>
            <h2>Initialising...</h2>
            <p className="muted-text">{authStatusLoading ? "Checking authentication requirements..." : "Connecting to Entra ID..."}</p>
          </div>
        </main>
      </div>
    );
  ...
  return (
    <div className="app-container">
      ...
      <header className="enterprise-header">
        <div className="brand-left">
          <img src="/image.jpg" alt="DIIaC Logo" className="brand-logo" />
          <div className="brand-text">
            <h1 className="brand-title">DIIaC&#8482; - Decision Intelligence Infrastructure as Code</h1>
            <span className="brand-product">
              DIIaC&#8482; provides Deterministic Decision Governance (DDG) for AI assisted decision making.
            </span>
          </div>
        </div>
        ...
        <div className="brand-right">
          <div className="header-controls">
            ...
            <div className="llm-selector">
              ...
              <span className="header-badge auth-active" title="Provider locked by deployment policy">
                Copilot
              </span>
            </div>
          ...
          {role === "admin" && (
            <>
              <div className="section-divider">
                <div className="line" />
                <span className="label">Admin Operations & Advanced Controls</span>
                <div className="line" />
              </div>
